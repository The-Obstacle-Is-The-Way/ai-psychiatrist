...
class ReferenceStore:
    ...
    def _load_embeddings(self) -> dict[int, list[tuple[str, list[float]]]]:
        ...
        # embedding pipeline (`scripts/generate_embeddings.py`). It is NOT user-supplied.
        # The path is controlled via DataSettings, which defaults to
        # `data/embeddings/participant_embedded_transcripts.pkl`.
        #
        # Do not load embeddings from untrusted sources. If external/untrusted
        # embeddings are ever needed, migrate to a safe format (e.g., NPZ/Parquet).
