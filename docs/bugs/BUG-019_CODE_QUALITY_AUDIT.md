...
**Status**: DEFERRED (LOW PRIORITY - Documented and understood)
**Severity**: P4
**Location**: `src/ai_psychiatrist/services/reference_store.py:86`
...
# migrate to a safe format (e.g., NPZ/Parquet).
...
When migrating to production, consider a safe format (e.g., `.npz`/Parquet) and
treat pickle inputs as untrusted.
...
| P2 | 0 | - |
| P3 | 0 | - |
| P4 | 2 | DOMAIN_KEYWORDS, pickle |
| **Total** | **2** | **Deferred improvements** |
...
2. Replace pickle embeddings with a safe format
