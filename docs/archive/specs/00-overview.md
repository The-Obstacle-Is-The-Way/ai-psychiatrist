...
tracked in `docs/results/reproduction-results.md` and `docs/archive/bugs/`.
...
| Paper sampling/quantization parameters unspecified | Can affect MAE/coverage and runtime | `docs/archive/bugs/gap-001-paper-unspecified-parameters.md` |
