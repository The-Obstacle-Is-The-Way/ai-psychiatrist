  WHAT WE HAVE NOW (Current Pipeline)
  ...
  ---
  WHAT WE'LL HAVE AFTER SPECS 061-063
  ...
  What 061-063 FIX: The output task problem. They sidestep the frequency issue by:
  - Allowing inference (063)
  - Aggregating errors (061)
  - Simplifying the task (062)

  What 061-063 DON'T FIX: The pipeline internals (evidence extraction, grounding, embedding).

  ---
  THE REMAINING HYPOTHESES - DEEP DIVE

  Now let's go through each one and explain what it would change vs what we have:
  ...
  ---
  THE BIG PICTURE: IS IT FUNDAMENTALLY INCORRECT?
  ...
  ---
  IF WE IMPLEMENTED EVERYTHING

  Here's what the "fully optimized" pipeline would look like:
